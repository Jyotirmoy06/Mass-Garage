            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="col_count_2">
                    ...
                    <div class="form_div">
                        ...
                        <input type="text" placeholder="Your Name" name="first_name" id="">
                    ...
                    <div class="form_div">
                        ...
                        <input type="text" placeholder="Your Last Name" name="last_name" id="">
                ...
                <div class="form_div">
                    ...
                    <input type="file" name="attachment[]" accept="application/pdf, image/*"  multiple="multiple"/>
