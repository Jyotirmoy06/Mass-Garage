...
<section class="banner" >
    <div class="owl-carousel owl-theme bannerSlider">
        ...
        <div class="item">
            <img src="/images/residential-banner.jpg" alt="">
            ...
            <div class="banner_text">
                ...
                <div class="wrapper">
                    ...
                    <div class="cont">
                        ...
                        <p>Our garage door technicians are available for you 24 hours a day, 7 days a week.

                            Our garage door service area includes <?php echo $city_name  ?> proper and the counties of Suffolk

                            MA, Middlesex MA, Norfolk MA, Plymouth MA, Bristol MA, Worcester MA, Essex MA,

                            Rockingham NH, Hillsborough NH, and Providence RI. Call now for your free

                            consultation and get the garage door you need.</p>

                        <ul class="btn_list">

                            <li><button onclick="show_workiz()" role="button" id="book_an_appointment" class="btn1">BOOK AN APPOINTMENT</button></li>

                            <li><a href="tel:<?=$printableNumber?>" class="btn2"><img src="images/phone.svg" alt="" style="width: 26px;display: inline-block;"><span class="respo">Call:
    ...
    <div class="grid">
        ...
        <div href="/residential-garage-doors.php" class="col">
            ...
            <div class="front">
                ...
                <img src="images/residential-icon.jpg" alt="">

                <div class="hover">

                    <div class="text">

                        <h4>Residential Garage Doors</h4>

                        <a href="/residential-garage-doors.php" class="btn1">More Info</a>
        ...
        <div href="#" class="col">
            ...
            <div class="front">
                ...
                <img src="images/commercial-garage-doors.jpg" alt="">
                ...
                <div class="hover">
                    ...
                    <div class="text">
                        ...
                        <a href="/commercial-garage-doors.php" class="btn1">More Info</a>
        ...
        <div href="#" class="col">
            ...
            <div class="front">
                ...
                <img src="images/gates-small.jpg" alt="">
                ...
                <div class="hover">
                    ...
                    <div class="text">
                        ...
                        <a href="#gate" class="btn1">More Info</a>
        ...
        <div href="#" class="col">
            ...
            <div class="front">
                ...
                <img src="images/storage-small.jpg" alt="">
                ...
                <div class="hover">
                    ...
                    <div class="text">
                        ...
                        <a href="#storage" class="btn1">More Info</a>
...
<section class="split_row">
    ...
    <div class="cont">
        ...
        <a href="/residential-garage-doors.php" class="btn1">Read More</a>
    ...
    <div class="cont">
        ...
        <ul style="margin-left:2.3% ;">
            <li style="list-style: disc;">
                Overhead/Sectional doors, either paneled or one-piece, track from the ceiling much like a residential garage, allow for add-on options like windows, insulation, remote entry locks, plus your choice of construction material; wood, aluminum, vinyl etc.
            </li>
            <li style="list-style: disc;">
                Roll up /Slat coiled doors are remarkable space savers because they roll up into self-contained tubes that free up ceiling storage space by avoiding the need to be tracked like the overhead sectional doors.
            </li>
            <li style="list-style: disc;">
                Fire Doors are a legal requirement if your business relies on operational equipment to be flammable, incendiary, chemical or other based fire or emissions hazard potential risk factors. Fire doors can be used as a containment or barrier prevention from other sections of your building; these doors can be operated manually or by auto-detected emergency activation sensors.
            </li>
            <li style="list-style: disc;">
                High-Speed garage doors are perfect for operation in temperate controlled work environments, pressure-sensitive sections, or severe extreme weather geographic regions.
            </li>
            <li style="list-style: disc;">
                Ultra-Sleek High-End Aluminum and/or Glass garage or access doors add the absolute upper niche to your business showroom, uber chic restaurants, and nightclubs. In addition, multi-staffed divided workspace areas that once utilized room dividers for boardrooms and office cubicles are also now opting for full floor to ceiling dividers. A must-consider contender for the upper trendy business owner.
...
<section class="split_row">
    ...
    <div class="cont">
        ...
        <p>I am Ronen Sisso, a visualist with a huge handle on the future of home/garage renovation techniques. That is why I quickly became New England’s top choice for superior custom creativity. I truly believe in top quality, not cookie-cutter mass quantity, and my ethics showcase this because I hand-selected and trained my design team to share my dreams and bring them to life on your stage with their own expertise. So, if you consider a “new look” feel for your garage, workshop, man cave, or shed, we are the crafts team for you.
