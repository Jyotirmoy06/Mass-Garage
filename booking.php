...
<section class="about_row1" style="background-color: black;">
    ...
    <div class="booking-header" style="text-align: center !important;">
        <h1 class="booking-header-text">GARAGE DOORS EXPERT APPOINTMENT</h1>
    </div>    

    <?php

        // var_dump($_COOKIE['trafficSource']);
        $bookingWidgetId = "VvBwmW3K0GxB465TKO1Y";
        $iframeId = "gpcBenlrxVi4V8j0sqaM_1731436849198";
        if($_COOKIE['trafficSource'] == "Facebook")
        {
            $bookingWidgetId = "osUoWGa5Lk5yoL40RJaA";
            $iframeId = "osUoWGa5Lk5yoL40RJaA_1731436979836";
        } 
    ?>

    <iframe class="booking-iframe-class" src="https://api.leadconnectorhq.com/widget/booking/<?=$bookingWidgetId?>" style="width: 100%; border:none;overflow: hidden; " scrolling="no" id="<?=$iframeId?>"></iframe>
    <br>
