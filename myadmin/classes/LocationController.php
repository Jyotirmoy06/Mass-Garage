...
class LocationController extends Database
{
    protected $table = 'location_page_contents';
    protected $primaryKey = 'id';
    protected $fillables = ['city','citySlug', 'county', 'countySlug', 'state', 'slug', 'image', 'map', 'pageType', 'status', 'metaTitle', 'metaDescription', 'h1', 'topBlackH3', 'topBlackHtml', 'textBlockTopLeft', 'blackTextSection1', 'textBlock2ndRight', 'blackTextSection2', 'textBlockBottomLeft'];
    protected $optional = ['state', 'image', 'map', 'pageType', 'status', 'metaTitle', 'metaDescription', 'h1', 'topBlackH3', 'topBlackHtml', 'textBlockTopLeft', 'blackTextSection1', 'textBlock2ndRight', 'blackTextSection2', 'textBlockBottomLeft'];
    protected $errors = [];
    protected $message = [];
    protected $values = [];
    protected $queryStr = "";
    ...
    public function store()
    {
        ...
        if (empty($this->errors) && count($this->errors) < 1)
        {
            ...
            if ($stmt){
                session_start();
                $this->message = ['success' => true, 'message' => 'Location saved successfully!!'];
