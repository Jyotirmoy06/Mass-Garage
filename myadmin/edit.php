...
if (isset($_GET['article']) && !empty($_GET['article']))
{
    ...
    $db = new Database();
    $article = $db->readData('cms_articles', [], ['id' => $art]);
    $pageTitle = "Edit Article | ".$article[0]->short_name ."- CMS";
}
else
{
                    ...
                    <div class="row">
                        <form action="<?= Root.'/inc/article_form.inc.php'; ?>" method="post" id="form" enctype="multipart/form-data" class="col-md-10 offset-1">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" value="<?= $article[0]->short_name ?: ''; ?>" class="form-control" id="short_name" name="short_name" placeholder="Short Name">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="long_name" name="long_name" value="<?= $article[0]->long_name ?: ''; ?>" placeholder="Long Name">
                            ...
                            ?>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="url_slug" name="url_slug" value="<?= $article[0]->url_slug ?: ''; ?>" placeholder="Slug">
                            ...
                            <div class="form-floating mb-3">
                                <select name="category_id" value="" class="form-control">
                                    ...
                                    if($cats)
                                    {
                                        ...
                                        {
                                        ?>
                                        <option value="<?= $cat['category_id'] ?>" <?= $article[0]->category_id == $cat['category_id'] ? 'selected': ''; ?>>  <?= $cat['short_name'] ?></option>
                                        <?php
                                        }
                                    }
                                    ?>
                            ...
                            <textarea name="article_summary" id="article_summary" class="form-control"  cols="10" rows="10" placeholder="">
                                <?= $article[0]->article_summary ?: ''; ?>
                            </textarea>
                            <br>
                            <?php
                            ...
                            ?>
                            <br>
                            <label for="editor" class="control-label mb-3">Content</label>
                            <!-- <textarea name="article_content" id="article_content" class="editor" cols="30" rows="10" placeholder=""> -->
                            <textarea name="article_content" id="editor" cols="30" rows="10" placeholder="">
                            ...
                            <div class="form-group my-3">
                                ...
                                <input type="hidden" name="small_image_url" value="<?= $article[0]->small_image_url ?: ''; ?>" id="small_image_url" class="form-control"/>

                                <div class="alert alert-danger" style="display: none; margin-top: 7px;" id="err-s"></div>
                                <div id="preview-s" style=" <?= $article[0]->small_image_url == '' ? 'display: none;': ''; ?> margin-top: 10px; width: 100px; height: 100px;">
                                    <label>Preview:</label><br/>
                                    <img src="<?= $article[0]->small_image_url ?: ''; ?>" style="width: 100%; height: auto; object-fit: cover;" alt="">
                                </div>
                            ...
                            <div class="form-group my-3">
                                ...
                                <input type="hidden" name="large_image_url" id="large_image_url" value="<?= $article[0]->large_image_url ?: ''; ?>" class="form-control"/>

                                <div class="alert alert-danger" style="display: none; margin-top: 7px;" id="err"></div>
                                <div id="preview" style="<?= $article[0]->large_image_url == '' ? 'display: none;': ''; ?> margin-top: 10px; width: 150px; height: 150px;">
                                    <label>Preview:</label><br/>
                                    <img src="<?= $article[0]->large_image_url ?: ''; ?>" style="width: 100%; height: auto; object-fit: cover;" alt="">
                                </div>
                            ...
                            <!-- <div class="form-group my-3"> -->
                                <!-- <textarea id="editor" name="article_content"> -->
                                    <?php // echo $article[0]->article_content; ?>
                                <!-- </textarea> -->
                            <!-- </div>         -->

                            <label for="status" class="control-label my-2">Show Large Image<br/></label>
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="large_image_status" id="image_status" style="height: 30px; width: 55px;" <?= $article[0]->large_image_status == '1' ? 'checked="true"': ''; ?> type="checkbox"  value="1">
                            </div>
                            <br/>
                            <label for="status" class="control-label my-2">Publish<br/></label>
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="status" id="status" style="height: 30px; width: 55px;" <?= $article[0]->status == '1' ? 'checked="true"': ''; ?> type="checkbox"  value="1">
                            </div>

                            <div class="my-4 d-flex justify-content-end">
                                <button name="submit" type="submit" class="mx-3 btn btn-success">Save</button>
                                <a href="<?= Root ?>/articles.php" onclick=" return confirm('Are you sure you want to exit this page')" class="btn btn-danger">Discard Changes</a>
                            </div>
                        </form>
                    </div>
                </div>
