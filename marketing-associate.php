...
<section class="about_row1" style="background-color: black;">
    ...
    <iframe class="booking-iframe-class" src="https://api.leadconnectorhq.com/widget/form/6gNS8RvjucOhhSRnuv9q" style="width: 100%; border:none;overflow: scroll;" scrolling="no" id="<?=$iframeId?>"></iframe>
    <br>
