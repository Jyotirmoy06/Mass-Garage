    ...
    <script>
        document.onreadystatechange = () => {
            ...
            if (document.readyState !== 'complete') {
                ...
                document.querySelector('.banner .owl-carousel').style.display = "none";
                ...
                document.querySelector('.banner .owl-carousel').style.display = "block";
...
<section class="main">
            ...
            <div class="number">
                ...
                <ul>
                    ...
                    <li class="languange" style="display: none;">
                        ...
                        <img src="/images/globe.svg" alt="" width="13"> en
                    ...
                    <li>
                        <a href="tel:<?=$printableNumber?>">
                            <img src="/images/phone.svg" alt="" width="30">
                            <?=$printableNumber?>
                        </a>
    ...
    <nav>
        ...
        <div class="navlogo"><img src="/images/logo.png" alt=""></div>
        ...
        <a href="tel:8889898758" class="nav_number">
            ...
            <img src="/images/phone.svg" alt="" width="30"><?=$printableNumber?></a>
